...
/**
 * This is the item provider adapter for a {@link video.Response} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResponseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VideoPackage.Literals.RESPONSE__RESPONSE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VideoPackage.Literals.RESPONSE__BODY);
		}
	...
	public String getText(Object object) {
		String label = ((Response)object).getResponse();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Response.class)) {
			case VideoPackage.RESPONSE__RESPONSE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case VideoPackage.RESPONSE__BODY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VideoPackage.Literals.RESPONSE__BODY,
