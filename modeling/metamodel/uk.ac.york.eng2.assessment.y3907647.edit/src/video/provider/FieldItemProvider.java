...
/**
 * This is the item provider adapter for a {@link video.Field} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VideoPackage.Literals.FIELD__NAME,
				 true,
				 false,
				 false,
	...
	protected void addFieldTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_fieldType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_fieldType_feature", "_UI_Field_type"),
				 VideoPackage.Literals.FIELD__FIELD_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
